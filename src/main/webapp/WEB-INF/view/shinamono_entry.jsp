...
<form action="SaveShinamono" method="post" enctype="">
	<p>
		名簿ID(仮):<input type="text" name="MEIBO_ID" value="<%=dto.getMeibo_id()%> maxlength="10">
	</p>
	<p>
		名前:<input type="text" name="AITENAME" value="<%=dto.getName()%> maxlength="10">
	</p>
  ...
  bunruiSelect.addEventListener('change', function() {
	...
	<div id="amountField" style="display: none;">
		金額：<input type="text" name="KINGAKU" maxlength="20" id="">
	</div>
